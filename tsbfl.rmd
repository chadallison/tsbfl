...
get_optimal_score = function(team, wk) {
  ...
  df = df |>
    mutate(used = ifelse(used == 1 | pnum == qb1n, 1, 0))
  ...
  df = df |>
    mutate(used = ifelse(used == 1 | pnum == qb2n, 1, 0))
  ...
  df = df |>
    mutate(used = ifelse(used == 1 | pnum == rbn, 1, 0))
  ...
  df = df |>
    mutate(used = ifelse(used == 1 | pnum == wrten, 1, 0))
  ...
  df = df |>
    mutate(used = ifelse(used == 1 | pnum == x1n, 1, 0))
  ...
  df = df |>
    mutate(used = ifelse(used == 1 | pnum == x2n, 1, 0))
  ...
  df = df |>
    mutate(used = ifelse(used == 1 | pnum == x3n, 1, 0))
  ...
  df = df |>
    mutate(used = ifelse(used == 1 | pnum == dstn, 1, 0))
  ...
  df = df |>
    mutate(used = ifelse(used == 1 | pnum == kn, 1, 0))
